...
For large exports, prefer **server-side** `s3flow`; for small sets, **presigned GET** URLs and a client-side zip library may suffice. Use **`recommendArchiveExecutionSurface`** for a stable hint. See [presigned-urls.md](presigned-urls.md).
