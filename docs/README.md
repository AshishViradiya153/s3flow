# s3download documentation

In-depth guides for using **s3download** as an npm package: streaming S3 (and compatible providers) into ZIP / tar / tar.gz archives with production-oriented hooks.
...
| Map imports (`@ashishviradiya153/s3download`, `@ashishviradiya153/s3download/platform`, …) to capabilities | [Reference: exports & modules](reference-exports.md)                           |
